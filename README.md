...
| (없음) | 단계마다 엔터를 기다린다 |
| `--auto` | 엔터 없이 전부 실행 |
| `--keep` | 끝나고 노드를 끄지 않는다 (Step 02, 05, 08, 09) |
...
### Step 05 · 08 · 09 가 `canton jar 을 찾을 수 없습니다` 로 멈춘다
...
canton/           Canton 노드 설정과 bootstrap 스크립트 (Step 05, 08, 09)
upgrade/          업그레이드 실습용 별도 패키지 v1 / v2 (Step 09)
